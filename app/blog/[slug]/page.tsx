...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
    ...
    return {
        title: `${post.title} | Best Houstun Chiros Blog`,
                ...
                <section className="bg-slate-900 text-white py-20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-xl text-slate-300 mb-10">
                            Find the best chiropractors in Houston for your specific needs
                        </p>
                        <Link
                            href="/"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all font-semibold text-lg hover:scale-105"
                        >
                            Find a Chiropractor
                        </Link>
                    </div>
