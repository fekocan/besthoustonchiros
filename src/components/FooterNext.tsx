        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-white">Best Houstun Chiros</h3>
            </div>
            <p className="text-slate-400 leading-relaxed mb-4">
              Connecting you with trusted, licensed chiropractors across the Houston metro area.
            </p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">For Chiropractors</h4>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-400">
              &copy; {currentYear} Best Houstun Chiros. All rights reserved.
            </p>
          ...
          <div className="mt-6 text-center md:text-left">
            <p className="text-xs text-slate-500">
              This directory provides information about chiropractors. It is not a substitute for
