      ...
      <div className="flex flex-col md:flex-row gap-0 md:items-center">
        ...
        <div className="md:flex-shrink-0 p-4 md:px-6 md:py-0 border-t md:border-t-0 border-slate-100">
          <Link
            ...
            className="flex md:inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-all hover:gap-3 font-medium shadow-sm w-full md:w-auto"
          >
            View Full Profile
